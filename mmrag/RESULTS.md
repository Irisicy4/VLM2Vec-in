...
| rl-grpo-judge-lr1e5 | rl | [gold] | algo=grpo, reward=judge, lr=1e-05, gold_in_pool=True, pool_sampling=False, num_candidates=8, max_steps=500, contrastive_coef=0.3, max_train_rows=all(~41k), profile=gme2b, seed=0 | 0.6017/0.8017 | 0.4159/0.6702 | 0.336 / 0.2547 (1500) |
...
| rl-grpo-judge-lr3e5 | rl | [gold] | algo=grpo, reward=judge, lr=3e-05, gold_in_pool=True, pool_sampling=False, num_candidates=8, max_steps=500, contrastive_coef=0.3, max_train_rows=all(~41k), profile=gme2b, seed=0 | 0.6133/0.774 | 0.4139/0.6637 | 0.342 / 0.248 (1500) |
...
| rl-ppo-judge-lr2e5 | rl | [gold] | algo=ppo, reward=judge, lr=2e-05, gold_in_pool=True, pool_sampling=False, num_candidates=8, max_steps=500, contrastive_coef=0.3, max_train_rows=all(~41k), profile=gme2b, seed=0 | 0.6067/0.799 | 0.4171/0.6751 | 0.3373 / 0.2547 (1500) |
