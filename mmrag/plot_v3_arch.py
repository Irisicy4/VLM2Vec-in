...
def build_spec(a):
    ...
    boxes = [
        ...
        ("polbody", 2.95, 1.14, 3.20, 2.76, "",
         [f"{backbone}", "FROZEN backbone", "",
          f"+ LoRA  r={a['lora_r']}, α={a['lora_alpha']}",
          "the only trained weights", "",
        ...
        ("rewbody", 9.90, 1.14, 3.10, 2.76, "",
         [f"frozen {reader}", f"scores each UNIQUE passage", f"of the G×k = {G*k} sampled", "",
